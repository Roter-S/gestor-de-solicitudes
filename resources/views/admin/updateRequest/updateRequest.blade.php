                            ...
                            <form method="POST" action=" {{ route('request-status.update', $request) }} ">
                                    ...
                                    <label>
                                        <select class="form-select" name="status">
                                            <option value="Aceptado"
                                                    @if ($request->status == 'Aceptado') selected @endif>Aceptado
                                            </option>
                                            <option value="Pendiente"
                                                    @if ($request->status == 'Pendiente') selected @endif>Pendiente
                                            </option>
                                            <option value="Rechazado"
                                                    @if ($request->status == 'Rechazado') selected @endif>Rechazado
                                            </option>
                                        </select>
                                    </label>
                                </td>
                                <td>
                                    ...
                                    <button class="btn btn-green" type="submit"
                                            onclick="return confirm('¿Desea actualizar el registro?')">Guardar
                                    </button>
                                </td>
                            </form>
                        </tr>
